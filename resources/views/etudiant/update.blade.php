        ...
        <div class="row">
            ...
            <form action="/update/traitement" method="POST" class="form-group">
                ...
                <div class="">
                    ...
                    <input type="text" name="nom" id="Nom" class="form-control" aria-describedby="Nom" value="{{$etudiants->nom}}">
                </div>
                <div class="">
                    <label for="Prenoms">Prenoms</label>
                    <input type="text" name="prenoms" id="Prenoms"class="form-control" aria-describedby="Votre prenoms" value="{{$etudiants->prenoms}}">

                </div>
                <div class="">
                    <label for="Classe" >Classe</label>
                    <input type="text" name="classe" id="Classe" class="form-control" aria-describedby="Classe" value="{{$etudiants->classe}}">
